...
class PolyCrossEntropyLoss(loss.LossBase):
    def __init__(
        self,
        num_classes: int,
        epsilon: float = 1.0,
        ...
        """
        Create instance of PolyCrossEntropyLoss
        :param num_classes:
        :param epsilon:
...
class PolyFocalLoss(loss.LossBase):
    def __init__(
        self,
        num_classes: int,
        epsilon: float = 1.0,
        ...
        """
        Create instance of PolyFocalLoss
    ...
    def forward(self, logits, labels):
        ...
        ce_loss = F.binary_cross_entropy_with_logits(
            input=logits, target=labels, reduction="none", weight=self.weight, pos_weight=self.pos_weight
        )
