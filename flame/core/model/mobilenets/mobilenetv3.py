...
class MobileNetV3(nn.Module):
    def __init__(self, inverted_residual_setting: List[InvertedResidualConfig],
                 last_channel: int, num_classes: int = 1000, block: Optional[Callable[..., nn.Module]] = None,
        ...
        layers.append(ConvBNActivation(3, firstconv_output_channels,
        ...
        self.classifier = nn.Sequential(nn.Linear(lastconv_output_channels, last_channel),
...
def _mobilenet_v3_model(arch: str, inverted_residual_setting: List[InvertedResidualConfig],
